import { ErrorCorrectionLevel } from "src/common/QR";
 ...
 * @export
 * @class RSBlock
 * @see https://github.com/nuintun/qrcode/blob/master/src/qrcode/encoder/RSBlock.ts
 */
export class RSBlock {
    ...
    public getErrorCorrectionCount(): number {
